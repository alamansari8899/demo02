    ...
    $(function() {
        $('#table').bootstrapTable(
         ...
         $('#table').on('editable-save.bs.table', function (e, field, row, old, $el) {
            ...
            //console.log('SAVE fired field changed : '+field+" new value : "+row[field]+" othe values of row : "+row["last name"]+ " ~ "+row["company"]);
               //id,name, price from header [data-field]
            console.log('SAVE fired field changed : '+field+" new value : "+row[field]+" other values of row : "+row.id+ " ~ "+row["first name"]+ " ~ "+row["last name"]+ " ~ "+row["company"]);
        });
